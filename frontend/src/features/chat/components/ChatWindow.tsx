            ...
            <div className="h-16 bg-[#202c33] flex items-center justify-between px-4 border-b border-gray-700 shrink-0">
                <div className="flex items-center cursor-pointer">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">{displayPhone || 'No phone number'}</p>
                    </div>
                </div>
            ...
            <div className="bg-[#202c33] px-4 py-2 flex items-center gap-2 shrink-0">
                ...
                <div className="flex-1 bg-[#2a3942] rounded-lg px-4 py-2 flex items-center">
                    <input
                        ...
                        className="w-full bg-transparent border-none focus:ring-0 text-gray-100 placeholder-gray-500 text-sm"
                    />
                </div>

                {inputValue.trim() ? (
                    <button onClick={handleSend} className="p-2 text-gray-400 hover:bg-gray-700 rounded-full">
