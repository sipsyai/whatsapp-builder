...
export const ComponentPalette: React.FC<ComponentPaletteProps> = ({
  ...
  return (
    <aside
      className={`w-72 bg-background-dark border-r border-[#23482f] flex flex-col h-full ${className}`}
    >
      {/* Header */}
      <div className="p-4 border-b border-zinc-700">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 bg-[#23482f] border border-transparent rounded-lg text-sm text-white placeholder:text-gray-400 focus:ring-2 focus:ring-primary focus:border-transparent"
          />
          {searchQuery && (
            <button
          ...
          filteredCategories.map((category) => (
            <div key={category.id} className="mb-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-3 bg-[#23482f] rounded-lg border border-transparent shadow-sm hover:bg-[#1a3523] transition-colors"
              >
