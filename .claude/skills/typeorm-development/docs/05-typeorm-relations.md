...
- [one-to-one](/docs/relations/one-to-one-relations) using `@OneToOne`
- [many-to-one](/docs/relations/many-to-one-one-to-many-relations) using `@ManyToOne`
- [one-to-many](/docs/relations/many-to-one-one-to-many-relations) using `@OneToMany`
- [many-to-many](/docs/relations/many-to-many-relations) using `@ManyToMany`
