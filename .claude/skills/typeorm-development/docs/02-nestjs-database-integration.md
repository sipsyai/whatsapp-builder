...
**💡 HINT**
Learn more about entities in the [TypeORM documentation](https://typeorm.io/docs/entity/entities/).
...
**💡 HINT**
To learn more about relations in TypeORM, visit the [TypeORM documentation](https://typeorm.io/docs/relations/relations).
...
**💡 HINT**
To learn more about associations in Sequelize, read [this chapter](https://github.com/RobinBuschmann/sequelize-typescript#model-association).

### Auto-load models (Sequelize)
